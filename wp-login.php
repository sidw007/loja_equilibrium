...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; Grupo Equilibrium &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Ir para Grupo Equilibrium</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/equilibrium\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/wp-includes/js/wp-util.min.js?ver=5.9.2" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"cf15b6d39e"};
</script>
